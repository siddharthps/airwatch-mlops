...
class TestLoadProcessedInferenceDataFromS3:
    ...
    def test_load_processed_inference_data_from_s3_success(self, sample_inference_data):
        ...
        # Test the function
        result = load_processed_inference_data_from_s3(
            bucket_name, key_prefix, file_name
        )
...
class TestGeneratePredictions:
    ...
    def test_generate_predictions_missing_features(
        self, mock_model, inference_data_missing_features
    ):
    ...
    def test_generate_predictions_preserves_original_data(
        self, mock_model, inference_data_complete
    ):
...
class TestSavePredictionsToS3:
    ...
    def test_save_predictions_to_s3_success(self, mock_datetime, predictions_data):
        ...
        expected_key = (
            "predictions/pm25_daily/pm25_predictions_2025_20250101_120000.parquet"
        )
...
class TestModelBatchPredictionFlow:
    ...
    def test_model_batch_prediction_flow_default_year(
        ...
        mock_prep_flow.assert_called_once_with(
            target_year=current_year, return_state=True
        )
...
@pytest.mark.parametrize(
    "prediction_values,expected_length",
    [
        ([12.5], 1),
        ([12.5, 15.2], 2),
