...
class TestTransformData:
    ...
    def test_transform_data_success(self, raw_data_with_dates):
        ...
        expected_features = ['year', 'month', 'day_of_week', 'day_of_year', 'is_weekend']
...
class TestWriteTransformedDataToS3:
    ...
    def test_write_transformed_data_to_s3_success(self, transformed_data):
        ...
        # Test the function
        write_transformed_data_to_s3(transformed_data, bucket_name, key_prefix, file_name)
    ...
    def test_write_transformed_data_to_s3_empty_dataframe(self):
        ...
        write_transformed_data_to_s3(empty_df, "test-bucket", "test_prefix", "test_file")
...
@pytest.mark.parametrize("date_input,expected_weekend", [
    ('2023-01-01', 1),  # Sunday
    ('2023-01-02', 0),  # Monday
...
@pytest.mark.parametrize("numeric_col,test_values,expected_type", [
